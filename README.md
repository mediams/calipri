...
- Таблица осей 1-го блока размещается почти вплотную под шапкой; между 1-м и 2-м блоками осей оставлен минимальный отступ (~0.5 мм).
- Внизу страницы добавлены два информационных блока (`REDBOX / SCU Konfiguration` и `PZB`) по макету.
- Для плотной компоновки на одной странице используются уменьшенные размеры шрифтов и отступов в матрицах/нижних блоках.
